...
namespace OldBadPixelSimpleApp
{
    //This is judt a place to dump some old code.
    //The reason for keeping it is that it has the code to transform the PCR back into an image
    class OldClass1
    {
